Vue.createApp({
  data() {
    return {
      ...
      konzerne:[
        {
          ...
          "brands": ["Volkswagen", "Audi", "Porsche", "SEAT", "Škoda"]
        },
        {
        ...
        },
        {
          ...
          "brands": ["Fiat", "Chrysler", "Jeep", "Dodge", "Ram"]
        },
        {
        ...
        {
          "name": "Volvo Group",
          "brands": ["Volvo", "Mack Trucks", "Renault Trucks"]
        },
        {
      ...
      zulieferer:[
        {
          "name": "Bosch",
          "products": ["Automotive components", "Industrial technology", "Consumer goods"]
        },
        {
          "name": "Continental AG",
          "products": ["Tires", "Brakes", "Powertrain", "Chassis & Safety"]
        },
        {
          "name": "Denso Corporation",
          "products": ["Automotive technology", "Electronics", "Thermal systems"]
        },
        {
          "name": "Magna International",
          "products": ["Body exteriors & structures", "Seating systems", "Power & vision", "Complete vehicles"]
        },
        {
          "name": "ZF Friedrichshafen",
          "products": ["Driveline and chassis technology", "Active & passive safety technology"]
        },
        {
          "name": "Valeo",
          "products": ["Driving assistance systems", "Powertrains", "Thermal systems"]
        },
        {
          "name": "Faurecia",
          "products": ["Seating systems", "Interiors", "Clean mobility"]
        },
        {
          "name": "Lear Corporation",
          "products": ["Seating", "E-Systems", "Interior"]
        },
        {
          "name": "Adient",
          "products": ["Seats", "Seating structures"]
        },
        {
          "name": "Thyssenkrupp",
          "products": ["Automotive technology", "Materials", "Industrial solutions"]
        },
        {
          "name": "Sumitomo Electric Industries",
          "products": ["Wiring harnesses", "Electrical components", "Electronic products"]
        },
        {
          "name": "BorgWarner",
          "products": ["Turbochargers", "Transmission systems", "Electric motors"]
        },
        {
          "name": "Gentex Corporation",
          "products": ["Automatic-dimming mirrors", "Rear vision systems"]
        },
        {
          "name": "Hanon Systems",
          "products": ["Heating, ventilation, and air conditioning systems", "Compressors"]
        },
        {
          "name": "Aptiv PLC",
          "products": ["Electrical architecture", "Signal and power solutions"]
        }
      ],
  ...
  computed: {
    ...
    filteredBooks() {
      ...
      return this.bookse.filter(book => book.publisher === "O'Reilly Media");
    },

    selectedColumns() {
      // Hier kannst du die Schlüssel auswählen, die du verwenden möchtest.
      const selectedKeys = ['title', 'isbn', 'author', 'publisher', 'price', 'numPages'];
      
      // Verwende die filter-Methode, um die Schlüssel aus dem Objekt zu filtern.
      return Object.keys(this.bookse[0] || {}).filter(key => selectedKeys.includes(key));
    },
